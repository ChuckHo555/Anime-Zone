  ...
  useEffect(() => {
    ...
    const checkUserLists = async () => {
      ...
      try {
        ...
        console.log("Fetched Watch Later:", isInWatchLater); 
        console.log("Fetched Favorites:", isInFavorites); 
        setIsInWatchLater(isInWatchLater);
        setIsInFavorites(isInFavorites);
      } catch (error) {
  ...
  const handleAction = async (
    ...
    try {
      ...
      if (listType === "watchLater") {
        console.log("Before Toggle Watch List:", isInWatchLater); 
        setIsInWatchLater(!isInWatchLater);
        console.log("After Toggle Watch List:", !isInWatchLater); 
        handleNotification(
          isAdding ? "Added to Watch Later!" : "Removed from Watch Later!"
        );
      } else if (listType === "favorites") {
        console.log("Before Toggle Favorites:", isInFavorites);
        setIsInFavorites(!isInFavorites);
        console.log("After Toggle Favorites:", !isInFavorites); 
        handleNotification(
